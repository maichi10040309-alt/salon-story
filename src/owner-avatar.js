import{OWNER_CANVAS,ownerAlphaBounds,ownerLayerAnchorSpec}from'./owner-asset-metadata.js?v=96';

const ROOT='./assets/owner/';
const OUTFIT_COUNT=13;
const TRYON_HAIR_PATH='hair/INITIAL_TRYON_HAIR_ONLY.png';
const TRYON_HAIR_STYLE='z-index:20;inset:auto;left:39.74609375%;top:.5208333%;width:17.08984375%;height:16.40625%;max-width:none;max-height:none;object-fit:fill;object-position:0 0;transform:none;filter:none';
