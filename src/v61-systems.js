...
export function previewFashionAppearance(current,item){const next={...normalizeOwnerAssetAppearance(current)},asset=ownerAssetForItem(item);if(!asset)return next;next.outfit=asset;next.dress=asset;next.tops=null;next.bottoms=null;next.outer=null;next.shoes=null;next.bag=null;next.accessories=null;next.hairStyle='HAIR_15';return next}
