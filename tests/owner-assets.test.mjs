...
assert.match(html,/owner-shoes-left/);assert.match(html,/owner-shoes-right/,'左右の靴を新bodyの足位置へ個別配置');
...
const shoes02=renderOwnerAvatar({...DEFAULT_OWNER_APPEARANCE,shoes:'SHOES_02'});assert.equal((shoes02.match(/SHOES_02\.png/g)||[]).length,2,'左右それぞれにSHOES_02を描画');
